...
class PublicApiTest(TestCase):
    ...
    def test_password_too_short(self):
        """Test an error is returned if password lass than 5 chars."""
        payload = {
            "email": "test@example.com",
            "password": "tt",
            "name": "Test Name",
    ...
    def test_create_token_blank_password(self):
        """Test posting a blank password returnes an error."""
    ...
    def test_update_password(self):
        """Test that updating the password for the authenticated user works."""
        user = create_user(email="first@example.com", password="oldpass1")
